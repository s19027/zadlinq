...
namespace LinqConsoleApp
{
    public class LinqSamples
    {
        ...
        */
        ...
        {
            object[] r2 = {"Brak wartości", null, null};
        ...
        {
            var res = Emps.Where(empl=>empl.Salary==Emps.Select(emp => emp.Salary)
                .Aggregate((r, next) =>
                {
                    int tmp = r;
        ...
        {
            var res = Depts.SelectMany(e => Emps,(x, y) => new { 
                Department_name = x.Dname, 
                Employee_name = y.Ename}); 
            foreach (var emp in res)
            {
                Console.WriteLine(emp);
            }
